...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "name", sa.String(), nullable=False, comment="User display name"
        ),
        sa.Column(
            "id", sa.Uuid(), nullable=False, comment="Unique identifier"
        ),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        "cars",
        sa.Column(
            "user_id", sa.Uuid(), nullable=False, comment="Owner user ID"
        ),
        ...
        sa.CheckConstraint(
            "year >= 1930", name=op.f("ck_cars_car_year_valid")
        ),
    ...
    op.create_table(
        "mileage_logs",
        sa.Column(
            "car_id", sa.Uuid(), nullable=False, comment="ID of the car"
        ),
        sa.Column(
            "odometer_km",
            sa.Integer(),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "car_id", "name", name="uq_service_items_car_name"
        ),
    )
    op.create_table(
        "reminders",
        ...
        sa.CheckConstraint(
            ...
            name=op.f(
                "ck_reminders_reminder_days_notification_requires_interval"
            ),
        ),
        sa.CheckConstraint(
            "notify_before_days IS NULL OR notify_before_days >= 0",
            name=op.f(
                "ck_reminders_reminder_non_negative_days_notification_threshold"
            ),
        ),
        sa.CheckConstraint(
            "notify_before_km IS NULL OR interval_km IS NOT NULL",
            name=op.f(
                "ck_reminders_reminder_km_notification_requires_interval"
            ),
        ),
        sa.CheckConstraint(
            "notify_before_km IS NULL OR notify_before_km >= 0",
            name=op.f(
                "ck_reminders_reminder_non_negative_km_notification_threshold"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["service_item_id"],
